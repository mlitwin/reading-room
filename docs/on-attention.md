...
The second failure mode is more insidious. It's when attention narrows so far onto the immediate task that I lose the *frame*. I stop asking whether I'm working on the right problem. I stop noticing that the path I'm on no longer leads where I wanted it to. The thing I'm doing has become the thing I'm doing, and the original reason has slipped out of view.

The trick — if there is a trick — is to alternate between the two modes. Drop into narrow focus for an hour or two, then back out and look at the frame. Are you still pointed at the thing that mattered when you started? Or has the work eaten its own purpose?

Most of the bad weeks I can remember were weeks where I forgot to come up for air.
