...
with $\omega_{i_1 \cdots i_k} \in C^\infty(U)$.

**Wedge product.** The wedge $\wedge: \Omega^k(M) \times \Omega^\ell(M) \to \Omega^{k+\ell}(M)$ is the alternating tensor product. On basis elements,
