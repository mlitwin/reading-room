...
**Phase space.** The state space of a Hamiltonian system is the cotangent bundle $T^* Q$ with coordinates $(q^i, p_i)$. It carries a canonical 2-form
$$\omega := dp_i \wedge dq^i$$
(the [symplectic form](note:symplectic-form)) that's non-degenerate and closed. Hamilton's equations are the integral curves of the vector field $X_H$ defined by $\iota_{X_H} \omega = dH$.
