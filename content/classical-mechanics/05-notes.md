...
A **symplectic form** on a smooth manifold $M$ is a [closed](../tensor-calculus-on-manifolds/03-differential-forms/03-closed-and-exact.md), non-degenerate [2-form](../tensor-calculus-on-manifolds/03-differential-forms/01-k-forms-and-wedge.md) $\omega \in \Omega^2(M)$. *Closed* means $d\omega = 0$; *non-degenerate* means the map $X \mapsto \iota_X \omega$ from vector fields to 1-forms is an isomorphism. A symplectic manifold has even dimension.
