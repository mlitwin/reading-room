...
The further story — vielbein/tetrad formulation, spin connection, the action written as a polynomial in differential forms — is the **Cartan formalism**, a separate (longer) topic. Pointers in [the notes page](../11-notes.md).
